...
// JSON 형식의 데이터를 tensor로 변환하고, 데이터를 정규화하며, 정규화에 사용된 최소/최대값을 반환
function convertToTensor(data) {
  return tf.tidy(() => {
    ...
    return {
      ...
      // denormalize에 사용하기 위해 min/max를 함께 반환
      inputMax,
      inputMin,
      labelMax,
      labelMin,
...
// 학습된 머신러닝 모델로 예측을 수행, 원본 데이터와 예측 결과를 시각화
function testModel(model, inputData, normalizationData) {
  ...
  tfvis.render.sctterplot(
    { name: "Model 예측값 vs Origianal Data" },
    {
